        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-8">
                <div className="flex justify-between items-center mb-4">
                    <div className="text-lg font-semibold"> {/* Modificato qui */}
                        <span className="text-blue-900">Domanda </span> {/* Modificato qui */}
                        <span className="text-blue-900 font-bold text-xl">{currentQuestionIndex + 1}</span> {/* Modificato qui */}
                        <span className="text-blue-900"> di </span>
                        <span className="text-blue-900 font-bold text-xl">5</span> {/* Modificato qui */}
                    </div>
                        ...
                        <div className="flex justify-between items-center">
                            <div className="text-center w-1/2">
                                ...
                                {playerSelectedForQuestion ? (
                                    <div className={`inline-block p-4 rounded-lg border-2 ${playerSelectedForQuestion === winner ? 'border-green-500 bg-green-700' : winner ? 'border-red-500 bg-red-700' : 'border-yellow-500 bg-yellow-700'}`}>
                                        <img 
                                        ...
                                        <p className="text-sm text-gray-300">{currentQuestion.detail(playerSelectedForQuestion)}</p>
                                    </div>
                                ) : (
                            ...
                            <div className="text-center w-1/2">
                                <h4 className="text-xl font-semibold mb-4 text-white">Scelta Computer</h4>
                                {computerSelectedForQuestion ? (
                                    <div className={`inline-block p-4 rounded-lg border-2 ${computerSelectedForQuestion === winner ? 'border-green-500 bg-green-700' : winner ? 'border-red-500 bg-red-700' : 'border-yellow-500 bg-yellow-700'}`}>
                                        <img 
                                        ...
                                        <p className="text-sm text-gray-300">{currentQuestion.detail(computerSelectedForQuestion)}</p>
                                    </div>
                                ) : (
                                    <p className="text-white">Nessuna risposta</p>
                                )}
